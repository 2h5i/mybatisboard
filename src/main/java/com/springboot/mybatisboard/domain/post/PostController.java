package com.springboot.mybatisboard.domain.post;

import com.springboot.mybatisboard.common.dto.MessageDto;
import com.springboot.mybatisboard.common.dto.SearchDto;
import com.springboot.mybatisboard.common.paging.PagingResponse;
...
public class PostController {
    ...
    public String savePost(final PostRequest params, Model model) {
        ...
        MessageDto message = new MessageDto("게시글 생성이 완료되었습니다.", "/post/list.do", RequestMethod.GET,
            null);
